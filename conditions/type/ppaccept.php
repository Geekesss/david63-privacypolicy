...
namespace david63\privacypolicy\conditions\type;

/**
 * Auto Groups Privacy Policy Accept class
 */
class ppaccept extends \phpbb\autogroups\conditions\type\base
{
	/**
	 * Get condition type
	 *
	...
	{
		return 'david63.privacypolicy.autogroups.type.ppaccept';
	}
